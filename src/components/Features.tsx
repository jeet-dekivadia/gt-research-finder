...
const features = [
  {
    icon: Search,
    title: 'Smart Search',
    description: 'Find research opportunities that perfectly match your interests and skills through our advanced filtering system.',
  },
  {
    icon: Brain,
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-display font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-gt-gold via-gt-gold-light to-white">
            Why Choose GT Research Finder?
          </h2>
          <p className="text-xl text-gray-300 font-display max-w-3xl mx-auto">
            Our platform streamlines the research discovery process, making it easier than ever to find your perfect research opportunity.
          </p>
        </motion.div>
